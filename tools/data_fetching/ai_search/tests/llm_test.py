...
def _assert(sub_path: str, min_match: int, fail_reason: str | None = None) -> None:
...
def test_intern() -> None:
    ...
    _assert("test/intern.txt", 0, "is_excluded_role")
